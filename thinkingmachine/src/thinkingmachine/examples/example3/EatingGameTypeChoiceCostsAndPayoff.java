package thinkingmachine.examples.example3;

import java.util.HashMap;

public class EatingGameTypeChoiceCostsAndPayoff {
	...
	public static void replicate(Object program) {
		...
		String choice = (String) EatingGameTypeChoiceCostsAndPayoff.preferredChoice.get("EAT");
	...
	public static void main(String[] args) {
		...
		EatingGameTypeChoiceCostsAndPayoff
