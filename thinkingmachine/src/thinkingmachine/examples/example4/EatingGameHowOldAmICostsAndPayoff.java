package thinkingmachine.examples.example4;

import java.util.HashMap;

public class EatingGameHowOldAmICostsAndPayoff {
	...
	public static void replicate(Object program) {
		...
		String choice = (String) EatingGameHowOldAmICostsAndPayoff.preferredChoice.get("EAT");
		...
		System.out.println("I am "+EatingGameHowOldAmICostsAndPayoff.age);
		age++;
	...
	public static void main(String[] args) {
		...
		EatingGameHowOldAmICostsAndPayoff
